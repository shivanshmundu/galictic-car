...
function draw() {
  ...
  if(gameState === play) {
    ...
    text("The asteroid distroy the galictic car",canvas.width/2-400,canvas.height/2+100);
    text(" final score:"+score,canvas.width/2-400,canvas.height/2+200);
  ...
  if(gameState === instruction) {
    ...
    text("  You are the galixy fighter.",canvas.width/2-300,canvas.height/2-170);
    ...
    text("  press 'a' to start game.",canvas.width/2,canvas.height/2-10);
